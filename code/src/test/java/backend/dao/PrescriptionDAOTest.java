...
public class PrescriptionDAOTest {
	...
	private PrescriptionDAO pp;
	
	public PrescriptionDAOTest() {
		pp = new PrescriptionDAO();
	...
	public void getDataTest() {
		List<Perscription> ps = null;
		String[] fields = {"PatientID"};
		String[] params = {"pooiqwiewqiqwiqpoqwoq"};
		
		ps = pp.getData(fields, params);
		
		assert(ps != null);
		
		for(Perscription p : ps) {
			System.out.println("Prescription : " + p.getPerscriptionName());
		}
	}
}
