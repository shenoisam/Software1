...
public class TestOrderDAOTest {
	private Connection c;
	private TestOrderDAO o;
	
	public TestOrderDAOTest() {
		o= new TestOrderDAO();
	...
	public void getDataTest() {
		List<TestOrder> list = null;
		String[] fields = {"DoctorID"};
		String[] params = {"adbacubasdibcuasdc"};
		
		list = o.getData(fields, params);
		
		assert(list != null);
		
		for(TestOrder element : list) {
			System.out.println("Test Order: " + element.getTestName());
		}
	}
}
