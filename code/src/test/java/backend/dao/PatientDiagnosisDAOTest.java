...
public class PatientDiagnosisDAOTest {
	private Connection c;
	private PatientDiagnosisDAO pd;
	
	public PatientDiagnosisDAOTest () {
		pd = new PatientDiagnosisDAO();
	...
	public void getDataTest() {
		List<PatientDiagnosis> patds = null;
		String[] fields = {"PatientID"};
		String[] params = {"pooiqwiewqiqwiqpoqwoq"};
		
		patds = pd.getData(fields, params);
		
		assert(patds != null);
		
		for(PatientDiagnosis patd : patds) {
			System.out.println("PatientDiagnosis: " + patd.getName());
		}
	}
}
